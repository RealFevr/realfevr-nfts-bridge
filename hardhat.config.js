...
require("@nomiclabs/hardhat-etherscan"); // npx hardhat verify ADDRESS --network networkToVerify (must be in config down there)
require("@nomiclabs/hardhat-ethers"); // ethers.js in scripts/tests
...
// require('@primitivefi/hardhat-dodoc'); // npx hardhat dodoc
...
const mainList = [
  ...
  process.env.BRIDGE_ROLE_PKEY,
  process.env.OPERATOR_ROLE_PKEY,
  process.env.FEE_RECEIVER_PKEY
]
