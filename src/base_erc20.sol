 ...
 */
contract base_erc20 is ERC20, Ownable(msg.sender) {
     ...
     */
    constructor(string memory _name, string memory _symbol, uint _totalSupply, uint8 decimals_) ERC20(_name, _symbol) {
        _decimals = decimals_;
        _mint(owner(), _totalSupply * 10 ** decimals_);
    }
