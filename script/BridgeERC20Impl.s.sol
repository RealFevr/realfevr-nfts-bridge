...
contract Base is Script {
    ...
    function attachContracts() public {
        ...
        bridge = ERC20BridgeImpl(address(789));
    }
    ...
    function deployBridge() public {
        ...
        bridge = ERC20BridgeImpl(address(new ERC1967Proxy(implementation, initializer_parameters)));
...
contract DepositInBridgeERC20 is Base {
    function run() external {
        ...
        ERC20BridgeImpl _bridge = ERC20BridgeImpl(0x425279c23657F5Fb59375258aE911d5B6C9edE45);
